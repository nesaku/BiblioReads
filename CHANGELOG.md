...
- Fix only the primary contributor being shown when multiple contributors are present [v4.0.0 Regression]
...
- Fix 404 error when locale is included in the URL - [(ISSUE)](https://github.com/nesaku/BiblioReads/issues/42)

## [3.6.0] - May 11, 2026

### Changed

- Use the Goodreads autocomplete API instead of scraping for search results
...
- Improve the library and search pages on smaller screens
...
- Refactor code to use a single function for DB initialization

### Fixed

- Fix db stores not being created properly

## [3.4.0] - Aug 4, 2025

### Added

- Add library import/export functionality - [(ISSUE)](https://github.com/nesaku/BiblioReads/issues/30)
- Add a method to delete all library data
- Add a type prop to select the toast type

### Fixed

- Fix the book cover and the placeholder cover both being visible at the same time

## [3.3.0] - Jun 11, 2025

### Added

- Add a button for loading more editions - [(PULL REQUEST)](https://github.com/nesaku/BiblioReads/pull/32)

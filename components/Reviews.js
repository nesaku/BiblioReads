  ...
  return (
    <div id="bookReviews">
      ...
      <button
        ...
        className="py-4 px-3 my-8 font-semibold text-md text-gray-100 dark:text-gray-300 bg-gray-800 rounded-md shadow-sm shadow-gray-800 hover:shadow-xl hover:bg-slate-800 transition duration-300 delay-40 hover:delay-40 ring ring-gray-600 "
      >

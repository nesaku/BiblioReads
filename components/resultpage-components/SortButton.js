  ...
  return (
    <button
      onClick={() => {
        ...
        props.setFilterStars(undefined);
      }}
      className={
        props.sortBy === props.value
          ...
          : "py-0.5 px-1 m-2 font-semibold text-md text-gray-900 dark:text-gray-300 bg-gray-300 dark:bg-gray-800 rounded-md shadow-sm shadow-rose-800 hover:shadow-xl hover:bg-rose-300 transition duration-300 delay-40 hover:delay-40 ring ring-gray-400 hover:ring-rose-600"
      }
    >
      {props.text}
    </button>
